...
from routers import (
    ...
    procurement, contratos, consejo, chatbot, organizaciones, proyectos,
...
app.include_router(personas_autorizadas.router, prefix="/api/personas-autorizadas",  tags=["Mi Apartamento"])
